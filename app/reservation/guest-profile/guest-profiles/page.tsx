...
import { UpdateGuestProfilesDrawer } from "@/components/drawers/update-guest-profiles-drawer";
...
const GuestProfilesPage = () => {
  ...
  //   dob: "",
  // });
  const [editingGuest, setEditingGuest] = useState<GuestProfilePayload | null>(null);
  // const [isEditDrawerOpen, setIsEditDrawerOpen] = useState(false);
  ...
  const openEdit = (guest: GuestProfilePayload) => {
