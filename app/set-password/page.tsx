...
export const dynamic = "force-dynamic"; // ➔ Force dynamic rendering (important)
...
export default function SetPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // const hotelmateTokens = localStorage.getItem("hotelmateTokens");
      // const accessToken = hotelmateTokens ? JSON.parse(hotelmateTokens).accessToken : null;
      ...
      const response = await fetch(`${BASE_URL}/api/SignUp/update-password`, {
        method: "POST",
        headers: {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.title || "Failed to update password.");
      }
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-2 bg-white text-black">
      {/* Left Panel */}
      <div className="bg-white text-black flex flex-col justify-center items-center px-6 md:px-16 py-12 relative">
        {success && (
          <Confetti
