...
export const fetchReservationRateDetails = createAsyncThunk<
  ...
  { reservationDetailId?: number; reservationId?: number; reservationStatusId?: number },
  { rejectValue: string }
>(
  "reservationRateDetails/fetch",
  async (params, { rejectWithValue }) => {
    try {
      const response = await axios.get(`${API_BASE_URL}/api/ReservationDetails/get-reservation-details`, {
        params,
      });
